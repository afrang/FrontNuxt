          ...
          <div class="row">
            <div class="col-xs-12 w-100 ">
              ...
              <div class="tab-content py-3 px-3 px-sm-0 w-100" id="nav-tabContent">
                <div class="tab-pane fade show w-100 active" style="width: 100%;" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
               sdsdadddddddddddddds
                </div>
...
<script>
    ...
    import ShowArticle from "../tools/Showarticle";
    export default {
